...
export const UI_WELCOME_TEXT     = "<strong>Welcome to Legendary Radio!</strong><br> " 
                                 ...
                                 + "Scroll through the list at your leisure, or type any search term to filter (by artist, album, song title, etc.) You can also use the drop-down menu to filter by a curated music category if you're trying to find something that fits a certain mood.<br>";
